...
export default function ImgUploadBtn() {
  ...
  return (
    <button
      className="relative flex h-[200px] w-[200px] flex-col items-center justify-center rounded border hover:border-primary-foreground hover:text-primary-foreground"
      onClick={(e) => {
        e.preventDefault();
